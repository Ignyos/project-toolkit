...
if (-not $gitCmd) {
    Write-Warning "Git CLI ('git') was not detected on PATH."
    Write-Warning "Git is required for GitHub Pages publishing and tagging."
} else {
    Write-Host "[Check] Git CLI detected." -ForegroundColor Green
}
...
Write-Host "  - Generate build.ps1, dev-publish.ps1, release.ps1, clean.ps1, and RELEASE_NOTES_STYLE.md."
